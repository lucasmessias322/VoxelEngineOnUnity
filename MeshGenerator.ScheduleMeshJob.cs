...
public static partial class MeshGenerator
{
    public static void ScheduleMeshJob(
        ...
        NativeArray<byte> blockVisualStateMask,
        NativeArray<BlockVisualStateTextureMapping> blockVisualStateTextures,
    ...
    )
    {
        ...
        var meshJob = new ChunkMeshJob
        {
            ...
            blockVisualStateMask = blockVisualStateMask,
            blockVisualStateTextures = blockVisualStateTextures,
