Shader "Voxel/URP/Voxel Blocks Unlit Lit"
{
    ...
    SubShader
    {
        ...
        void ResolveVoxelVertexData(Attributes input, out float3 positionWS, out half3 normalWS, out float2 localUV, out float2 atlasOrigin, out float2 atlasSize, out half4 extra, out half3 tintColor, out half subchunkIndex, out half blockLight, out half3 blockLightColor)
        {
            positionWS = 0.0.xxx;
