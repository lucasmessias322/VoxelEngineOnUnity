Shader "Voxel/URP Mobile/Leaves Unlit AO"
{
    Properties
    {
        ...
        [Header(Cutout)]
        [ToggleUI] _AlphaClip("Alpha Clip", Float) = 1.0
    ...
    SubShader
    {
        ...
        half4 MobileForwardFragment(Varyings input) : SV_Target
        {
            ...
            half3 albedo = surface.rgb * input.tintAndBlockLight.rgb;
            ...
            half faceShade = ComputeLeafFaceShade(normalWS);
